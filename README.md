...
2️⃣ Feature scaling
3️⃣ Model training using Gradient Boosting
4️⃣ Target scaling for accurate predictions
...
1️⃣ User selects environmental conditions using sliders
2️⃣ Input values are converted into a feature vector
3️⃣ Features are scaled using the trained feature scaler
4️⃣ Scaled data is passed to the trained model
5️⃣ Model predicts scaled power output
6️⃣ Target scaler converts prediction back to actual units
...
2️⃣ Add dependency list in requirements.txt
3️⃣ Connect GitHub repository to Streamlit Cloud
4️⃣ Deploy using app.py
